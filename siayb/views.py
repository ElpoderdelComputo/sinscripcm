...
from sinsevi.models import Coordinaciones, estudiante_consejero, Capcurs, Catacurs, Becarios, Asistira, Catabeca, \
...
def mis_cursos_siayb(request):
    ...
    if estudiante.email_ayb > 0:
        return redirect('siayb:altas_bajas')
...
def selecciona_cursoAyB(request):
    ...
    if capcursos_count == 6:
        ...
        url = reverse('siayb:mis_cursos_siayb')
        ...
        if form_asistira.is_valid() and form_sinsevi.is_valid() and form_alta_baja.is_valid():
            ...
            if asistira_existente:
                ...
                try:
                    ...
                    print('De capcurs: ->', micurso.id, micurso.cve_curso, micurso.cve_academic_id)
...
def guardar_boletayb(request):
    ...
    if cve_program == 'ECD':
        ...
        programa = get_object_or_404(Coordinaciones, cve_program='ECD')
